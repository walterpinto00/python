...
Este repositorio contiene un entregable con la carpeta llamada condicionales Python y en ella se incluyen los archivos de extensión py[cite: 1]. 
El proyecto fue desarrollado por Walter Fabian Pinto Gutiérrez como parte de las evidencias para el tecnólogo en Análisis y Desarrollo de Software (ADSO) del SENA.

## Descripción del Proyecto
El documento central requiere construir el código en Python para cada uno de los enunciados que se presenta[cite: 1]. Algunos de los algoritmos desarrollados incluyen:
